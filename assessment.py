...
def get_melon_price(melon_name):
    ...
    melon_prices = {"Watermelon": 2.95, "Cantaloupe": 2.50, "Musk": 3.25, "Christmas": 14.95}
...
def translate_to_pirate_talk(phrase):
    ...
    """
    english_to_pirate = {"sir": "matey", "hotel": "fleabag inn", "man": "matey",
                         "professor": "foul blaggart", "restaurant": "galley",
                         "your": "yer", "excuse": "arr", "student": "swabbie",
                         "students": "swabbies", "are": "be", "restroom": "head",
                         "my": "me", "is": "be"}

    words = phrase.split()

    pirate_phrase = [english_to_pirate.get(word, word) for word in words]
